...
const iniciaJogo = () => {
    ...
    mario.src = (imagemMario == './assets/img/mario.gif') ? './assets/img/mario.gif' : './assets/img/mario-yoshi.gif';

    // Mostra:
    $(".mario").css("display", "flex");
    $(".cano").css("display", "flex");
    $(".game-board").css("borderBottom", "15px solid rgb(35, 160, 35");
